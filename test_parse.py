...
class TestParse(unittest.TestCase):
    ...
    def test_request_with_multiple_paths(self):
        request_string = (
            "GET /index.html /about.html HTTP/1.1\nHost: example.com\n\n"
        )
    ...
    def test_request_with_multiple_versions(self):
        request_string = (
            "GET /index.html HTTP/1.1 HTTP/2.0\nHost: example.com\n\n"
        )
    ...
    def test_request_with_invalid_header_name(self):
        request_string = (
            ...
            "User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:82.0) "
    ...
    def test_request_with_invalid_header_value_too_long(self):
        request_string = (
            ...
            "application/xhtml+xml,application/xml;q=0.9,"
            "image/webp,image/apng,*/*;q=0.8\nInvalid-Header: "
            "value12345678901234567890123456789012345678901234567890"
        )
